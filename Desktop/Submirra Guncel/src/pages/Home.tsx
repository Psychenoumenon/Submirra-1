      ...
      <div className="relative pt-24 md:pt-32 pb-16 md:pb-20 px-4 md:px-6 z-10">
        <div className="max-w-6xl mx-auto text-center">
          <div className="mb-6 md:mb-8 inline-block animate-fade-in">
            <h1 
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-3 md:mb-4 bg-clip-text text-transparent py-2 leading-tight px-2"
              style={{
                background: 'linear-gradient(90deg, #f472b6, #c084fc, #a78bfa, #818cf8, #22d3ee, #c084fc, #f472b6)',

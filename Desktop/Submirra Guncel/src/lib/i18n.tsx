...
const translations: Record<Language, Translations> = {
  en: {
    ...
    home: {
      ...
      feature3Details: 'Dream Journal • Save Dreams • Statistics • Your History',
    ...
    about: {
      ...
      socialDesc: 'Share your dreams, like and comment on others\' posts, and connect through direct messages. To protect your security and the site\'s reputation, you can report inappropriate users - reporting problematic behavior is important for everyone\'s safety.',
    ...
    social: {
      ...
      close: 'Close',
      noPlanMessage: 'You need at least a free plan to view the social feed',
    },
    profile: {
      title: 'Profile',
    ...
    auth: {
      ...
      acceptAge: 'I confirm that I am 18 years of age or older',
      ...
      mustAcceptAge: 'You must confirm that you are 18 years of age or older',
    ...
    settings: {
      ...
      showReadReceiptsDesc: "Let others know when you've seen their messages",
      readReceiptsEnabled: 'Read receipts enabled',
      readReceiptsDisabled: 'Read receipts disabled',
      readReceiptsUpdateError: 'Failed to update read receipts setting',
      deleteAccount: 'Delete Account',
      deleteAccountDesc: 'Permanently delete your account and all associated data.',
      deleteAccountButton: 'Delete My Account',
      deleteAccountConfirm: 'Are you sure you want to delete your account? This action cannot be undone. All your dreams, data, and subscription will be permanently deleted.',
    ...
    pricing: {
      ...
      freeTrial: {
        ...
        feature2: '7 visual dream analyses total',
        feature3: '7 days of advanced analysis access',
      ...
      standard: {
        ...
        price: '$3',
        period: 'month',
        description: 'Unlock deeper insights into your dreams with advanced analysis',
      ...
      premium: {
        ...
        price: '$9',
        period: 'month',
        description: 'Transform your dreams into art with multiple visuals and priority analysis',
        feature1: 'Access to social features',
    ...
    terms: {
      ...
      paymentFeature3: 'We offer a 7-day free trial so you can explore all features risk-free',
      ...
      contactText: 'If you have any questions about these Terms of Service, please',
    ...
    privacy: {
      ...
      dataCollectionItem1: 'Account information: email address and username',
      ...
      dataStorageText: 'Your data is stored securely with industry-standard encryption on secure servers. We retain your information for as long as your account is active or as needed to provide our services. You can delete your account and all associated data at any time from your profile settings.',
      ...
      userRightsItem2: 'Modify: You can update your profile information and username',
      ...
      contactText: 'If you have any questions, concerns, or requests regarding this Privacy Policy or your personal information, please',
      contactLink: 'contact us',
    },
  },
  tr: {
    ...
    home: {
      ...
      feature3Details: 'Rüya Günlüğü • Rüya Kaydet • İstatistikler • Geçmişiniz',
    ...
    about: {
      ...
      socialDesc: 'Rüyalarınızı paylaşın, başkalarının paylaşımlarını beğenip yorum yapın ve DM ile bağlantı kurun. Güvenliğinizi ve sitenin itibarını korumak adına uygunsuz kullanıcıları şikayet edebilirsiniz - sorun çıkaran kullanıcıları bildirmek hem bizim hem sizin açınızdan önemlidir.',
    ...
    social: {
      ...
      close: 'Kapat',
      noPlanMessage: 'Sosyal akışı görüntülemek için en az bedava plana sahip olmalısınız',
    },
    profile: {
      title: 'Profil',
    ...
    auth: {
      ...
      acceptAge: '18 yaşından büyük olduğumu onaylıyorum',
      ...
      mustAcceptAge: '18 yaşından büyük olduğunuzu onaylamalısınız',
    ...
    settings: {
      ...
      deleteAccountConfirm: 'Hesabınızı silmek istediğinizden emin misiniz? Bu işlem geri alınamaz. Tüm rüyalarınız, verileriniz ve aboneliğiniz kalıcı olarak silinecektir.',
    ...
    pricing: {
      ...
      freeTrial: {
        ...
        feature2: 'Toplam 7 görselli rüya analizi',
        feature3: '7 gün boyunca gelişmiş analiz hakkı',
        feature4: 'Rüyalarınız için güzel görselleştirmeler',
        cta: 'Ücretsiz Deneyin',
        signUp: 'Ücretsiz Kaydol',
        alreadyUsed: 'Kullanıldı',
      },
      standard: {
        title: 'Standart',
        price: '₺100',
        period: 'ay',
        description: 'Gelişmiş analiz ile rüyalarınızın derinliklerine inin',
      ...
      premium: {
        ...
        price: '₺300',
        period: 'ay',
        description: 'Rüyalarınızı çoklu görsellerle sanata dönüştürün ve öncelikli analiz alın',
        feature1: 'Sosyal kısmına erişim hakkı',
        ...
        feature10: 'Sosyalde hayal galerisi kilidi açılır',
      ...
      ruyagezer: {
        ...
        feature12: 'Sosyalde hayal galerisi kilidi açılır',
      },
    },
    trial: {
    ...
    terms: {
      ...
      paymentFeature3: 'Tüm özellikleri risk almadan keşfetmeniz için 7 günlük ücretsiz deneme sunuyoruz',
      ...
      contactText: 'Bu Hizmet Şartları hakkında sorularınız varsa, lütfen bizimle',
    ...
    privacy: {
      ...
      dataCollectionItem1: 'Hesap bilgileri: e-posta adresi ve kullanıcı adı',
      ...
      dataStorageText: 'Verileriniz endüstri standardı şifreleme ile güvenli sunucularda saklanır. Hesabınız aktif olduğu sürece veya hizmetlerimizi sunmak için gerekli olduğu sürece bilgilerinizi saklarız. Hesabınızı ve tüm ilişkili verileri istediğiniz zaman profil ayarlarınızdan silebilirsiniz.',
      ...
      userRightsItem2: 'Değiştirme: Profil bilgilerinizi ve kullanıcı adınızı güncelleyebilirsiniz',
      ...
      contactTitle: '8. Bize Ulaşın',
      contactText: 'Bu Gizlilik Politikası veya kişisel bilgileriniz hakkında herhangi bir sorunuz, endişeniz veya talebiniz varsa, lütfen bizimle',
      contactLink: 'iletişime geçin',
    },
  },
};

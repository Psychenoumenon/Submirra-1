...
import { User, CreditCard, Loader2, AlertCircle, CheckCircle2, Shield, Star, Lock, Bell } from 'lucide-react';
...
export default function Settings() {
  ...
  const handleCancelSubscription = async () => {
    ...
    const confirmMessage = language === 'tr'
      ? `${planType === 'premium' ? 'Premium' : planType === 'standard' ? 'Standard' : 'Trial'} planınızı iptal etmek istediğinizden emin misiniz? Bu işlem geri alınamaz ve planınız "Free" planına dönüştürülecektir.`
      : `Are you sure you want to cancel your ${planType} plan? This action cannot be undone and your plan will be downgraded to Free.`;

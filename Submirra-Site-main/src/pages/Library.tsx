        ...
        {dreams.length === 0 ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredDreams.map((dream) => (
              ...
              >
                {/* Pending/Processing durumunda loading ikonu göster - Sadece görsel analizler için */}
                {(dream.status === 'pending' || dream.status === 'processing') && (dream.analysis_type === 'basic_visual' || dream.analysis_type === 'advanced_visual') ? (
